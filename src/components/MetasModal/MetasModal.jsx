...
export default function MetasModal({ aberto, fechar }) {
    ...
    const carregar = useCallback(async () => {
        try {
            ...
            const lista = lojasData.map((loja) => {
                const meta = metasData.find((m) => m.loja === loja.id);
                            ...
                            <tr key={m.loja}>
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            const lista = [...metas];
                                            lista[index].meta_mensal = Number(
                                                e.target.value
                                            );
                                            setMetas(lista);
                                        }}
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            const lista = [...metas];
                                            lista[index].abre_sabado = e.target.checked
                                                ? 1
                                                : 0;
                                            setMetas(lista);
                                        }}
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            const lista = [...metas];
                                            lista[index].abre_domingo = e.target.checked
                                                ? 1
                                                : 0;
                                            setMetas(lista);
                                        }}
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            const lista = [...metas];
                                            lista[index].feriados = Number(e.target.value);
                                            setMetas(lista);
                                        }}
                                    />
                                </td>
